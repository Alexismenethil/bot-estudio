...
| page_number | integer | NOT NULL, ≥ 1, ≤ documents.page_count — the citation source of truth |
...
| status | text | NOT NULL, CHECK in ('pending_retry','evaluated') — 'pending_retry' = both engines failed, text preserved (FR-030, US5-AC5) |
